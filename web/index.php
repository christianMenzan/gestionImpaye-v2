...
<title>CIE | Recouvrement des impayés des abonnés BT en vigueur</title>
            ...
            <nav>
                <div class="container_12">
                    <div class="grid_12">
                        ...
                        <a href="login.php" title="Logout" class="button icon-with-text fr"><img src="images/navicons-small/129.png" alt=""/>Déconnexion</a>
                        <div class="user-info fr">
                            Profil : <a href="#">Administrateur</a>
                        </div>
                    </div>
                </div>
            </nav>
            ...
            <aside>
                <nav class="drilldownMenu">
                    <h1>
                        ...
                        <button title="Go Back" class="back">Retour</button>
                    </h1>
...
<!--                        <li class="hasul"><a href="#"><img src="images/navicons/111.png" alt=""/><span>Administrator</span></a>
                            <ul>
                                ...
                                <li><a href="login.php" title="Logout"><img src="images/navicons/129.png" alt=""/><span>Logout</span></a></li>
                            </ul>
                        </li>-->
                        <li><a href="#dashboard.php" title="Tableau de bord"><img src="images/navicons/81.png" alt=""/><span>Tableau de bord</span></a></li>
<!--                        <li><a href="#contacts.php" title="Contacts"><img src="images/navicons/123.png" alt=""/><span>Contacts</span></a></li>
                        <li><a href="#media.php" title="Media"><img src="images/navicons/42.png" alt=""/><span>Media</span></a></li>-->
<!--                        <li class="hasul"><a href="#" title="Forms"><img src="images/navicons/139.png" alt=""/><span>Forms</span></a>
                            <ul>
                                <li><a href="#forms1.php" title="Form Sample 1"><span>Form Sample</span></a></li>
                                <li><a href="#forms2.php" title="Custom Form Elements"><span>Custom Form Elements</span></a></li>
                            </ul>
                        </li>-->
                        <!--<li><a href="#wizard.php" title="Wizard"><img src="images/navicons/165.png" alt=""/><span>Wizard</span></a></li>-->
                        <li class="current"><a href="#etat.php" title="Exécuter Etat"><img src="images/navicons/29.png" alt=""/><span>Exécuter Etats</span></a></li>
                        <li><a href="#"><img src="images/navicons/20.png" alt=""/><span>Paramètres</span></a>
<!--                            <ul>
                                <li><a href="#calendar.php" title="Calendar"><img src="images/navicons/83.png" alt=""/><span>Calendar</span></a></li>
                                <li><a href="#wysiwyg.php" title="WYSIWYG Editor"><img src="images/navicons/26.png" alt=""/><span>WYSIWYG Editor</span></a></li>
                            </ul>-->
                        </li>
<!--                        <li class="hasul"><a href="#"><img src="images/navicons/96.png" alt=""/><span>Documentation</span></a>
                            <ul>
                                <li><a href="#doc-intro.php" title="Documentation"><span>Introduction</span></a></li>
                                <li><a href="#doc-forms.php" title="Documentation"><span>Forms</span></a></li>
                                <li><a href="#doc-media.php" title="Documentation"><span>Media</span></a></li>
                                <li><a href="#doc-notifications.php"><span>Notifications</span></a></li>
                                <li class="hasul"><a href="#"><span>Widgets</span></a>
                                    <ul>
                                        <li><a href="#doc-calendar.php" title="Documentation"><span>Calendar</span></a></li>
                                        <li><a href="#doc-wysiwyg.php" title="Documentation"><span>WYSIWYG</span></a></li>
                                        <li><a href="#doc-graph.php" title="Documentation"><span>Graph</span></a></li>
                                        <li><a href="#doc-popover.php" title="Documentation"><span>Pop Over</span></a></li>
                                        <li><a href="#doc-style.php" title="Documentation"><span>Style</span></a></li>
                                    </ul>
                                </li>
                                <li><a href="#doc-wizard.php"><span>Wizard</span></a></li>
                            </ul>
                        </li>-->
                    </ul>
                </nav>
            ...
            <div class="content">
                <nav>
                    <ul>
                        ...
                        <li class="read"><a><span class="avatar"></span>John Doe deleted a project</a></li>
                        <li class="read"><a><span class="avatar"></span>John Doe marked a project as done</a></li>
                        <li><a href="#notifications.php" title="Notifications">See notification styles and growl like messages...</a></li>
                    </ul>
                </nav>
            </div>
        </section>
